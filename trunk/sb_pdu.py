...
class __sb_pdu_header__:
	...
	return __sb_pdu_header__(command_id,command_status,sequence_number)
...
class __sp_bind_resp__(__sb_pdu_header__):
    def __init__(self,system_id,sc_interface_version="",command_id=smpp_command_id["bind_transceiver_resp"],command_status_id=smpp_statuses["ESME_ROK"],sequence_number=0):
	self.system_id = system_id
